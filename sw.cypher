CREATE
  (Episode1:Movie {title: 'Episode I: The Phantom Menace'}),
  (Episode2:Movie {title: 'Episode II: Attack of the Clones'}),
  (Episode3:Movie {title: 'Episode III: Revenge of the Sith'}),
  (Episode4:Movie {title: 'Episode IV: A New Hope'}),
  (Episode5:Movie {title: 'Episode V: The Empire Strikes Back'}),
  (Episode6:Movie {title: 'Episode VI: Return of the Jedi'}),
  (Episode7:Movie {title: 'Episode VII: The Force Awakens'}),
